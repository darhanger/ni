...
local abilities = {
	["test"] = function ()
		...
		then ni.frames.floatingtext:message("\124cffff0000Shred!")
			return false
		end
	end,
	...
	["FaerieFire"] = function ()
		...
		and UnitExists(t))
		then ni.spell.cast (spells.FaerieFireFeral.name, t)
		end
	end,
	...
	["FB"] = function()
		...
		and GetComboPoints(p, t) == 5
		then ni.spell.cast (spells.FerociousBiteCat.id, t)
		end
	end,
	["FB25"] = function()
		if ni.player.buff(spells.CatForm.id)
	...
	["FrenziedRegenerationBear"] = function()
		...
		and  ni.player.hp()< value 
			then ni.spell.cast (spells.FrenziedRegenerationBear.name)
			end 
		end,
	["Taunt"] = function ()
	...
	["MangleBear"] = function()
		...
		and ni.player.buff(spells.BearForm.id)
		and ni.unit.inmelee(p, t)
			then ni.spell.cast(spells.MangleBear.id, t)
		end
	end,
	...
	["LacerateBear"] = function()
		...
		and ni.unit.inmelee(p, t)
			then ni.spell.cast(spells.LacerateBear.id, t)
			end
		end,
