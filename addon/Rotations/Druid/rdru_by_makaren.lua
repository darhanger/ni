...
local items = {
    settingsfile = "rdru_by_makaren.json",
...
local function OnLoad()
	ni.GUI.AddFrame("rdru_by_makaren", items);
end;
local function OnUnLoad()  
	ni.GUI.DestroyFrame("rdru_by_makaren");
end;
local cache = {
    IsMoving = false,
    sindra = false,
...
|cFFFF0000=========================|r")
	...
	ni.bootstrap.profile("rdru_by_makaren", queue, abilities, OnLoad, OnUnLoad);
else
	local queue = {
        "Error",
    };
    ...
    ni.bootstrap.profile("rdru_by_makaren", queue, abilities);
end;