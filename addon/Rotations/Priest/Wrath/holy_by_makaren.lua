...
local items = {
    ...
    { type = "entry", text = ni.spell.icon(64901).." Гимн надежды", tooltip ="Использует Гимн надежды, |cFFFF0000с Тотемом прилива маны|r", enabled = true, key = "gimn_mp" },
    { type = "entry", text = ni.spell.icon(64843).." Божественный гимн", tooltip ="Использует Божественный гимн, |cFFFF0000в критические моменты|r", enabled = true, key = "gimn_hp" },
    { type = "entry", text = ni.spell.icon(19236).." Молитва отчаяния", tooltip ="Использует Молитву отчаяния, |cFFFF0000в критические моменты|r", enabled = true, key = "molitva_save" },
    { type = "entry", text = ni.spell.icon(47788).." Оберегающий дух", tooltip ="Использует Оберегающего духа, |cFFFF0000в критические моменты|r", enabled = true, key = "duh" },
    ...
    { type = "entry", text = ni.spell.icon(34433).." Авто пет", tooltip ="Автоматически вызывает пета на 60% мп", enabled = true, key = "pet" },
    { type = "page", number = 2, text = "|cffFFFF00Диспел|r" },
    { type = "separator" },
    { type = "entry", text = ni.spell.icon(988).." Диспел", tooltip ="Диспелит все что может", enabled = true, key = "decurse" },
    { type = "entry", text = ni.spell.icon(32375).." Использовать масс диспел", tooltip ="Использует масс диспел при количестве игроков", enabled = true,value = 2, min = 2, max = 10, step = 1, width = 40,  key = "decurse_3" },
    ...
    { type = "separator" },
    { type = "entry", text = ni.spell.icon(48068).." Обновление по танкам", tooltip ="Поддерживает обновление на танках", enabled = true, key = "tank_obn" },
    { type = "entry", text = ni.spell.icon(48071).." Флешка в танка", tooltip = "Использует флешку при HP танка < 50%", enabled = true, key = "tank_fle" },
