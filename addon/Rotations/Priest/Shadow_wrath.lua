...
local function OnLoad()
	ni.combatlog.registerhandler("Shadow_wrath", CombatEventCatcher);
	ni.GUI.AddFrame("Shadow_wrath", items);
end
local function OnUnload()
	ni.combatlog.unregisterhandler("Shadow_wrath");
	ni.GUI.DestroyFrame("Shadow_wrath");
end
...
["Shadowfiend"] = function()
	...
	ni.bootstrap.profile("Shadow_wrath", queue, abilities, OnLoad, OnUnload);
else
    local queue = {
        "Error",
    };
    ...
    ni.bootstrap.profile("Shadow_wrath", queue, abilities);
end;