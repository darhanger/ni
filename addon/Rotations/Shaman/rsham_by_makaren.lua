...
local items = {
    settingsfile = "rsham_by_makaren.json",
...
local function OnLoad()
	ni.GUI.AddFrame("rsham_by_makaren", items);
end;
local function OnUnLoad()  
	ni.GUI.DestroyFrame("rsham_by_makaren");
end;
local cache = {
    IsMoving = false,
    stopcast = false,
...
["pet_dispell"] = function()
	...
	ni.bootstrap.profile("rsham_by_makaren", queue, abilities, OnLoad, OnUnLoad);
else
	local queue = {
        "Error",
    };
    ...
    ni.bootstrap.profile("rsham_by_makaren", queue, abilities);
end;