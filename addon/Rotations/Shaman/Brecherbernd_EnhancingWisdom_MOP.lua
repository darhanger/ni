...
local items = {
	settingsfile = "Brecherbernd_EnhancingWisdom_MOP.json",
...
local function OnLoad()
	ni.GUI.AddFrame("Brecherbernd_EnhancingWisdom_MOP", items);
end
local function OnUnLoad()  
	ni.GUI.DestroyFrame("Brecherbernd_EnhancingWisdom_MOP");
end	
...
["Elemental Mastery"] = function()
	...
	ni.bootstrap.profile("Brecherbernd_EnhancingWisdom_MOP", queue, abilities, OnLoad, OnUnLoad);	
else
    local queue = {
        "Error",
    };
    ...
    ni.bootstrap.profile("Brecherbernd_EnhancingWisdom_MOP", queue, abilities);
end;