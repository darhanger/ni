...
local items = {
	...
	{ type = "separator" },	
	{ type = "entry", text = ni.spell.icon(324, 20, 20).." Lightning Shield (Max. |cff0082FFMP|r %)", tooltip = "Use spell when player |cff0082FFMP|r > %.", value = 35, min = 15, max = 85, step = 1, width = 40, key = "lshield" },
	{ type = "entry", text = ni.spell.icon(52127, 20, 20).." Water Shield (Min. |cff0082FFMP|r %)", tooltip = "Use spell when player |cff0082FFMP|r < %.", value = 15, min = 15, max = 65, step = 1, width = 40, key = "wshield" },
	...
	{ type = "separator" },	
	{ type = "entry", text = ni.spell.icon(30823, 20, 20).." Shamanistic Rage (|cff0082FFMP|r)", tooltip = "Use spell when player |cff0082FFMP|r < %.", enabled = true, value = 35, min = 15, max = 65, step = 1, width = 40, key = "rage" },			
	{ type = "separator" },
	{ type = "title", text = "|cffFFFF00Important Settings|r" },
	{ type = "separator" },
	{ type = "entry", text = ni.spell.icon(22888, 20, 20).." Boss Detect", tooltip = "When |cff00D700ENABLED|r - Auto detect Bosses.\nWhen |cffFF0D00DISABLED|r - use CD bottom for Spells.", enabled = true, key = "detect" },	
	{ type = "entry", text = ni.spell.icon(6603, 20, 20).." |cffffa500Auto Target|r", tooltip = "Auto Target and Auto Attack nerest targets.", enabled = true, key = "AutoAttack" },	
	{ type = "entry", text = ni.spell.icon(2382, 20, 20).." |cffffa500Debug Printing|r", tooltip = "Enable for debug if you have problems.\n\nUse the macro |cff00D700/ppause|r to pause CR.\n\nThe value in the seconds field for which the CR will stop.", value = 1.5, min = 1, max = 6, step = 0.1, width = 40, enabled = false, key = "Debug" },
	{ type = "page", number = 2, text = "|cffEE4000Rotation Settings #1|r" },
	{ type = "separator" },
	{ type = "entry", text = ni.spell.icon(57994, 20, 20).." Auto Interrupt", tooltip = "Auto check and interrupt all interruptible spells.", enabled = true, key = "autointerrupt" },	
	{ type = "entry", text = ni.spell.icon(370, 20, 20).." Purge", tooltip = "Purge proper buff from enemie.\n\nThe numbers indicate the interval in sec.\nat which the ability will be recast.", value = 2.5, min = 0.1, max = 10, step = 0.1, width = 40, enabled = true, key = "purge" },	
	{ type = "entry", text = ni.spell.icon(76780, 20, 20).." Bind Elemental (Auto Use)", tooltip = "Auto check and use spell on proper enemies.", enabled = false, key = "bindelem" },
	{ type = "entry", text = ni.spell.icon(51514, 20, 20).." Auto Control (Allys)", tooltip = "Auto check and control member if he mindcontrolled or etc.", enabled = true, key = "control" },	
	{ type = "separator" },
	{ type = "title", text = "|cffFFFF00Bursts|r" },
	{ type = "separator" },
	{ type = "entry", text = ni.player.itemicon(40211, 20, 20).." Using Potions", tooltip = "Enabling the use of potions.\n\nTo work, enter the ID of the potion.\n\nUsing: \n|cff00D700• Work only if Boss Detect enabled\nor activated manual CD mode.|r\n• You can also use the macro |cff00D700/usepot.|r", enabled = false, value = 0, min = 0, width = 60, key = "usePots" },	
	{ type = "entry", text = ni.spell.icon(51533, 20, 20).." Feral Spirit", tooltip = "Add spell in CR.\n\n|cff00D700Work only if Boss Detect enabled\nor activated manual CD mode|r.", enabled = true, key = "feral" },	
	{ type = "page", number = 3, text = "|cffEE4000Rotation Settings #2|r" },
	{ type = "separator" },	
	{ type = "title", text = "|cffFFFF00AoE Settings|r" },
	{ type = "separator" },
	{ type = "entry", text = ni.spell.icon(421, 20, 20).." Chain Lightning", tooltip = "Enable spell for auto AoE.\n\nThe field indicates the number of enemies >=\nthe given value in the field.", enabled = true, value = 1, min = 1, max = 4, step = 1, width = 40, key = "chain" },
	...
	{ type = "separator" },
	{ type = "entry", text = ni.spell.icon(1535, 20, 20).." Fire Nova (AoE)", tooltip = "When |cff00D700ENABLED|r automatically changes rotation\ndepending on the enemies count.\n\nWhen |cffFF0D00DISABLED|r to use AoE\npress the AoE mode button.\n\nThe field indicates the number of enemies >=\nthe given value in the field.", value = 2, min = 1, max = 6, step = 1, width = 40, enabled = true, key = "firenovaAoE" },	
	{ type = "separator" },
	{ type = "title", text = "Dispel" },
	{ type = "separator" },
	{ type = "entry", text = ni.spell.icon(52798, 20, 20).." Delay For Dispeling", tooltip = "Delay in seconds or ms before you dispel something.", value = 1.5, min = 0.1, max = 5, step = 0.1, width = 40, key = "DispelDelay" },
	{ type = "entry", text = ni.spell.icon(51886, 20, 20).." Cleanse Spirit", tooltip = "Auto dispel debuffs from player.", enabled = true, key = "toxins" },
	...
	{ type = "separator" },	
	{ type = "entry", text = ni.spell.icon(36936, 20, 20).." Totemic Recall", tooltip = "Recall totem when you left combat.", enabled = true, key = "totemrecall" },
	{ type = "separator" },
	...
	{ type = "separator" },
	{ type = "entry", text = ni.spell.icon(77472, 20, 20).."Greaete Healing Wave (Self)", tooltip = "Use spell when player |cff00D700HP|r < %.\n\n|cffFF0D00Work only in open world!|r", enabled = true, value = 65, min = 15, max = 85, step = 1, width = 40, key = "waves" },
	...
	{ type = "separator" },
	{ type = "entry", text = ni.spell.icon(5730, 20, 20).." Stoneclaw Totem", tooltip = "Use "..ni.spell.icon(5730, 14, 14).."[Stoneclaw Totem] when player |cff00D700HP|r <%\nand have "..ni.player.itemicon(45778, 14, 14).."[Glyph of Stoneclaw Totem].", enabled = true, value = 25, min = 1, max = 100, step = 1, width = 40, key = "stoneclaw" },
	{ type = "entry", text = ni.spell.icon(30823, 20, 20).." Shamanistic Rage", tooltip = "Use spell when player |cff00D700HP|r < %.", enabled = true, value = 40, min = 15, max = 100, step = 1, width = 40, key = "rageSave" },		
	{ type = "separator" },
