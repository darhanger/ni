...
if wotlk then
local items = {
	settingsfile = "Mage - Fire PvE by Dreams - Wrath.json",
...
local function OnLoad()
	ni.GUI.AddFrame("Mage - Fire PvE by Dreams - Wrath", items);
end

local function OnUnLoad()  
	ni.GUI.DestroyFrame("Mage - Fire PvE by Dreams - Wrath");
end
...
local abilities = {
	...
	ni.bootstrap.profile("Mage - Fire PvE by Dreams - Wrath", queue, abilities, OnLoad, OnUnLoad);	
else
    local queue = {
        "Error",
    };
    ...
    ni.bootstrap.profile("Mage - Fire PvE by Dreams - Wrath", queue, abilities);
end;