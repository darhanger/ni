...
local items = {
	settingsfile = "Brecherbernd_Arkanist_MOP.json",
...
local function OnLoad()
	ni.GUI.AddFrame("Brecherbernd_Arkanist_MOP", items);
end
local function OnUnLoad()  
	ni.GUI.DestroyFrame("Brecherbernd_Arkanist_MOP");
end	
...
["Arcane Blast"] = function()
	...
	ni.bootstrap.profile("Brecherbernd_Arkanist_MOP", queue, abilities, OnLoad, OnUnLoad);	
else
    local queue = {
        "Error",
    };
    ...
    ni.bootstrap.profile("Brecherbernd_Arkanist_MOP", queue, abilities);
end;