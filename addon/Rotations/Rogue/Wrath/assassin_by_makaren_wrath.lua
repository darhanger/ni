...
local items = {
    settingsfile = "assassin_by_makaren_wrath.json",
...
local function OnLoad()
	ni.GUI.AddFrame("assassin_by_makaren_wrath", items);
end;
local function OnUnLoad()  
	ni.GUI.DestroyFrame("assassin_by_makaren_wrath");
end;
local cache = {
    PlayerCombat = false,
    aoe = false,
...
|cFFFF0000=========================|r")
	...
	ni.bootstrap.profile("assassin_by_makaren_wrath", queue, abilities, OnLoad, OnUnLoad);
else
	local queue = {
        "Error",
    };
    ...
    ni.bootstrap.profile("assassin_by_makaren_wrath", queue, abilities);
end;