...
local items = {
	settingsfile = "Rogue WotLK - Combat PvE by Dreams .json",
...
local function OnLoad()
	ni.GUI.AddFrame("Rogue WotLK - Combat PvE by Dreams", items);
end

local function OnUnLoad()  
	ni.GUI.DestroyFrame("Rogue WotLK - Combat PvE by Dreams");
end
...
local abilities = {
	...
	ni.bootstrap.profile("Rogue WotLK - Combat PvE by Dreams", queue, abilities, OnLoad, OnUnLoad);
else
    local queue = {
        "Error",
    };
    ...
    ni.bootstrap.profile("Rogue WotLK - Combat PvE by Dreams", queue, abilities);
end;