...
local items = {
    settingsfile = "hpal_by_makaren.json",
...
local function OnLoad()
	ni.GUI.AddFrame("hpal_by_makaren", items);
end;
local function OnUnLoad()  
	ni.GUI.DestroyFrame("hpal_by_makaren");
end;
local cache = {
    IsMoving = false,
    sindra = false,
...
["dd"] = function()
	...
	ni.bootstrap.profile("hpal_by_makaren", queue, abilities, OnLoad, OnUnLoad);
else
	local queue = {
        "Error",
    };
    ...
    ni.bootstrap.profile("hpal_by_makaren", queue, abilities);
end;