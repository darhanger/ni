local setmetatable, type, select, sort, wipe, ipairs, tremove, tos = setmetatable, type, select, sort, wipe, ipairs,
		tremove, tostring
local UnitGroupRolesAssigned, UnitIsGhost, UnitHealthMax, UnitName, UnitGUID, UnitIsUnit = UnitGroupRolesAssigned,
		UnitIsGhost, UnitHealthMax, UnitName, UnitGUID, UnitIsUnit
local IsInRaid, GetNumRaidMembers, GetNumPartyMembers, GetNumGroupMembers, UnitClass, UnitCanAssist = IsInRaid,
		GetNumRaidMembers, GetNumPartyMembers, GetNumGroupMembers, UnitClass, UnitCanAssist
local UnitAffectingCombat, UnitHealth, UnitHealthMax, CheckInteractDistance, UnitAffectingCombat = UnitAffectingCombat,
		UnitHealth, UnitHealthMax, CheckInteractDistance, UnitAffectingCombat
local CreateFrame, CanInspect, GetTalentInfo, GetSpellInfo, IsSpellInRange, GetRaidRosterInfo = CreateFrame, CanInspect,
		GetTalentInfo, GetSpellInfo, IsSpellInRange, GetRaidRosterInfo
local GetNumTalentTabs, GetActiveTalentGroup, GetTalentTabInfo, GetNumTalents = GetNumTalentTabs, GetActiveTalentGroup,
		GetTalentTabInfo, GetNumTalents
...
function memberssetup:create(unit, guid, subgroup)
	...
	function o:updatemember()
		...
		o.spec = wotlk and roster[o.guid] and roster[o.guid].specName or (aux_roster[o.guid] and aux_roster[o.guid].spec) or
				"None"
